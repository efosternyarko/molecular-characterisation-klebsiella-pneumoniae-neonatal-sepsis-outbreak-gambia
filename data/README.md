...
| File | Description | Source |
|------|-------------|--------|
| `pNS39_A_alignment_coverage_summary.tsv` | Per-sample BWA-MEM alignment coverage against pNS39_A reference plasmid (columns: `Sample_ID`, `Ref_Coverage_%`, `Identity_%`) | Generated by: `bwa mem pNS39_A_ref.fasta <reads> \| samtools sort \| samtools coverage` |
